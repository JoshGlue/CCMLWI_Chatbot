...
def load_data(PATH='./variables/', concatenate=False, multiple_simpson=5):
...
metadata, idx_q, idx_a = load_data(concatenate=True)
...
if not os.path.exists('ckpt/homer/'):
    os.makedirs('ckpt/homer/')
